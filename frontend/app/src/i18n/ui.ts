...
export const ui = {
    en: {
        ...
        'industry.blueprints.leading_text': 'Most orders require blueprints to fulfill. Find who is in possession the ones you need.',
        ...
        'freight.volume_placeholder': 'e.g. 60k or 60,000',
        ...
        'page_finder.freight_contracts.description': 'Courrier contracts tracking.',
        'page_finder.freight_contracts.history.description': 'History of courrier contracts.',
        ...
        'money_input_placeholder': 'e.g. 50M or 50,000,000',
        ...
        'view_market_expectations': 'View contracts',
        ...
        'sell_orders.deselect_all_groups': 'Deselect all',
        'sell_orders.select_categories': 'Select categories to include',
        'sell_orders.select_all_categories': 'Select all',
        'sell_orders.deselect_all_categories': 'Deselect all',
        ...
        'showing_contracts_singular': 'Showing 1 contract',
        'no_freighter_contracts': 'There are no currently freighter contracts.',
        'contract_outstanding': 'Outstanding',
        'contract_in_progress': 'In progress',
        'contract_finished': 'Finished',
        'space_trucker_ranking': 'Space trucker ranking',
        'volumen': 'Volumen',
        'not_taken': 'Not taken',
        ...
        'find_blueprints': 'Find blueprints',
        'get_blueprints_error': 'An error ocurred fetching the blueprints',
        'blueprints_plural': '{count} blueprints',
        'blueprints_singular': '1 blueprint',
        'blueprint_copies_plural': '{count} blueprint copies',
        'blueprint_copies_singular': '1 blueprint copy',
        'showing_blueprints_plural': 'Showing {count} blueprints.',
        'showing_blueprints_singular': 'Showing 1 blueprint.',
        'showing_blueprint_copies_plural': 'Showing {count} blueprint copies.',
        'showing_blueprint_copies_singular': 'Showing 1 blueprint copy.',
        'find_blueprints_placeholder': 'Type the blueprint name to find',
        'find_blueprint_copies_placeholder': 'Type the blueprint copy name to find',
        'no_blueprints_to_display': 'No blueprint found.',
        'no_blueprint_copies_to_display': 'No blueprint copy found.',
        'material_efficiency': 'Material efficiency',
        'time_efficiency': 'Time efficiency',
        'infinite_runs': 'Infinite runs',
        'runs_count_plural': '{count} runs left',
        'runs_count_singular': '1 run left',
        'Hangar': 'Hangar',
        'Cargo': 'Cargo',
